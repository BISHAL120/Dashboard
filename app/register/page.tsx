...
export default function FUILoginWithCardLayout() {
  ...
  return (
    <div>
      <div className="flex min-h-[100vh] relative items-center justify-center bg-gray-100 px-4 dark:bg-white">
          ...
          <form className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="flex items-center">
                ...
                <button
                  type="button"
                  className="absolute right-0 px-4 text-gray-700 dark:text-gray-300"
