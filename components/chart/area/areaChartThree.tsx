...
const chartData = [
  ...
  { date: "2024-06-24", desktop: -132, mobile: 880 },
...
export function AreaChartFour() {
  ...
  const filteredData = chartData.filter((item) => {
    ...
    //TODO: Change the time to new Date()
  ...
  const downloadPng = () => {
    const TargetDiv = document.getElementById("ChartPNG4");
    if (TargetDiv) {
      toPng(TargetDiv)
        .then((dataUrl) => {
      ...
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        <div className="grid flex-1 gap-1 text-center sm:text-left">
          <CardTitle className=" text-3xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-pink-500">
            ...
            <button onClick={downloadPng} className="ml-10">
