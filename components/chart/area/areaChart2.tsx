...
export function AreaChartOne2({ className }: { className?: string }) {
  return (
    <div className={`${className} w-full xl:max-w-[380px]`}>
      <Card
        id="ChartPNG2"
        className="flex flex-col justify-around relative w-full xl:w-[370px] xl:h-[450px] xl:max-h-[450px] xl:max-w-[380px]"
      >
